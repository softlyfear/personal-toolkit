#!/bin/bash
#####################################################################
# Configuring the server to run as root with ssh access only
#####################################################################
# Make sure you have access to the private ssh key before starting
# Create a key pair - ssh-keygen -t rsa
#####################################################################
# Automatic setup
# source <(curl -s https://raw.githubusercontent.com/softlyfear/my-script/main/server-setup-automatic.sh)
#####################################################################
