...
run_all_scenarios() {
  sep; info "Argument parsing (no apt-get reached)"; sep
  ...
  sep; info "Real installs — each builds/starts its own container"; sep
  ...
  sep; info "--interactive dialog"; sep
  ...
  sep; info "12 — idempotency: install git twice on the same container"; sep
